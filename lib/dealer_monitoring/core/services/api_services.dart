...
class ApiServices {
  ...
  // String baseUrl = "http://web36.185.238.new.ocpwebserver.com/api/v1/dm";
  // String baseUrl = "https://6mztnd0t-3000.inc1.devtunnels.ms/api/v1/dm";
  String baseUrl = "https://scopeapi.sparecare.in/api/v1/dm";

  Future<Map<String, dynamic>> getUserRole({required int userId}) async {
  ...
  Future<Map<String, dynamic>> getPartDetails({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          'success': false,
          'message': 'There is some problem to fetch data'
        };
      }
    } on TimeoutException {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          ...
          'message': msg == "Invalid Partnumber"
              ? msg
              : 'There is some problem to fetch data',
        };
      }
    } on TimeoutException {
      // print("Request timed out. Please try again.");
  ...
  Future<Map<String, dynamic>> fetchVehiclePPNIValuesByAdvisor({
    ...
    // print('--- Debugging Input Data ppni-v ---');
    // print(requestBody);
  ...
  Future<Map<String, dynamic>> fetchPPNIParts({
    ...
    try {
      ...
      // print("response of ppni parts: ${response.body}");
      if (response.statusCode == 200) {
        final Map<String, dynamic> json = jsonDecode(response.body);
        if (json.containsKey('Data') && json['Data'] is List) {
  ...
  Future<Map<String, dynamic>> getRemarksItem({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          'success': false,
          'message': 'There is some problem to fetch remarks'
        };
      }
    } on TimeoutException {
      return {'success': false, 'message': 'Request timed out'};
...
// """);
    ...
    try {
      ...
      if (streamed.statusCode == 200) {
        ...
        return {
          'success': false,
          'message': 'There is some problem to add remarks',
        };
      }
    } on TimeoutException {
      return {'success': false, 'message': 'Request timed out'};
  ...
  Future<Map<String, dynamic>> vehicleSearchLog({
    required String vehicleNumber,
    required String userId,
  }) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          'success': false,
          'message': "There is some problem to vehicle log"
        };
      }
    } on TimeoutException {
      return {'success': false, 'message': 'Request timed out'};
  ...
  Future<Map<String, dynamic>> vehicleSearchCheckBox({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return {
          'success': false,
          'message': "There is some problem to confirmation job card"
        };
      }
    } on TimeoutException {
      return {'success': false, 'message': 'Request timed out'};
