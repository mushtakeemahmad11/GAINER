...
class ReusableTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // final fixedColumnWidths = <int, TableColumnWidth>{};
    // final scrollableColumnWidths = <int, TableColumnWidth>{};
    //
    // if (columnWidths != null && columnWidths!.length >= 2) {
    //   for (int i = 0; i < columnWidths!.length; i++) {
    //     if (i < 2) {
    //       fixedColumnWidths[i] = columnWidths![i];
    //     } else {
    //       scrollableColumnWidths[i - 2] = columnWidths![i]; // index reset
    //     }
    //   }
    // }
    ...
    //               .take(2)
    //               // .map((h) => _buildCell("$h\n", isHeader: true))
    //               .map((h) => _buildCell(h, isHeader: true))
    //               .toList(),
    //         ),
