...
import '../../gainer/widget/dialog.dart';
...
import 'gainer_stock_check/show_part_details.dart';
          ...
          children: [
            ...
            Obx(() {
              return DropdownButton<String>(
                value: _locationController.selectedLocation.value == ''
                    ? null
                    : _locationController.selectedLocation.value,
                hint: const Text('Location'),
                underline: SizedBox(),
                icon: Icon(Icons.arrow_drop_down, color: Colors.black),
                items: _locationController.locationIdMap.keys.map((String key) {
                ...
                onChanged: (String? newValue) {
                  if (newValue != null) {
                    _locationController.selectedLocation.value = newValue;

                    String locationId =
                        _locationController.locationIdMap[newValue].toString();
                    _locationController.selectedLocationId.value = locationId;
                    _locationController
      ...
      body: Obx(() {
        return PopScope(
          canPop: dMMainController.currentScreen.value ==
              0, // Only allow pop if on the app_switcher_view screen
            ...
            child: Center(
              child: ListTile(
                ...
                leading: CircleAvatar(
                  radius: 26,
                  child: Obx(() =>
                      reusableProfile(null, dMMainController.photo.value)),
                ),
                title: SingleChildScrollView(
                  child: Obx(() => Text(
                        '${dMMainController.fName.value} ${dMMainController.lName.value}', // Displaying user's name
