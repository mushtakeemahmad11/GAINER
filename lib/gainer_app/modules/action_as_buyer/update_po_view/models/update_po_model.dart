...
class UpdatePoModel {
  ...
  late final TextEditingController accCtrl = TextEditingController(
    text: (sellerFreeStock < dispatchQty ? sellerFreeStock : dispatchQty)
        .toInt()
        .toString(),
  );
  void dispose() {
  ...
  factory UpdatePoModel.fromJson(Map<String, dynamic> json) {
    return UpdatePoModel(
      status: json["Status"] ?? "",
