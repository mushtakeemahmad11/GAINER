...
class PRFilterSheet extends GetView<PartReceiptController> {
  const PRFilterSheet({super.key});
  ...
  Widget _menuButton(String title) {
    return Obx(() {
      // final isSelected = controller.selectedOrderType.value == title;
      final isSelected = controller.tempSelectedOrderType.value == title;
      return GestureDetector(
        // onTap: () => controller.selectedOrderType.value = title,
  ...
  //     child: ListView(
  //       children: [
  //         _section('Dealer', controller.dealers.toList(),
  //             controller.selectedDealers),
  //         _section('Location', controller.locations.toList(),
  //             controller.selectedLocations),
  //         // _sectionPart('Part No', controller.partNos.toList(), controller.selectedPartNos),
  //         _sectionPart(
  //             'Part No', controller.partNdDesc, controller.selectedPartNos),
  //       ],
  //     ),
  //   );
  // }
  ...
  // Widget _sectionPart(
  //     String title, Map<String, String> data, RxSet<String> selected) {
  ...
  //             // onChanged: (_) => controller.toggle(selected, entry.key),
  ...
  // Widget _section(String title, List<String> data, RxSet<String> selected) {
  //   return ExpansionTile(
  //     title: Text(title),
  //     children: data
  //         .map(
  ...
  //               onChanged: (_) => controller.toggle(selected, item),
  //               title: Text(item),
  //             ),
  //           ),
  //         )
