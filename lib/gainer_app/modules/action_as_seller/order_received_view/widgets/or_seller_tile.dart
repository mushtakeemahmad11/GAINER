...
import 'or_details_card.dart';
import 'or_expansion_tile_header.dart';

class ORSellerTile extends StatelessWidget {
  final OrderReceivedSellerModel group;
  const ORSellerTile({super.key, required this.group});
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: GainerExpansionTile(
          titleWidget: ORExpansionTileHeader(
