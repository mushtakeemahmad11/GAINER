class ShowPartAvailabilityModel {
  final String status;
  final int id;
  ...
  factory ShowPartAvailabilityModel.fromJson(Map<String, dynamic> json) {
    return ShowPartAvailabilityModel(
      status: json["Status"] ?? "",
      id: json["ID"] ?? 0,
...
//   //     sellerLocationID: json['SellerLocationID'] ?? '',
//   //     sellerDealer: json['SellerDealer'] ?? '',
//   //     sellerLocation: json['SellerLocation'] ?? '',
//   //     dealerVerified: json['DealerVerified'] ?? '',
//   //     scsVerified: json['SCSVerified'] ?? '',
...
//   //     partNumber: json['PARTNUMBER'],
//   //     sellerStock: json['SellerStock'] == null
//   //         ? 0.0
//   //         : double.parse(json['SellerStock'].toString()),
//   //     freeStock: json['FreeStock'] == null
//   //         ? 0.0
//   //         : double.parse(json['FreeStock'].toString()),
//   //     sellerZoneName: json['SellerZoneName'] ?? '',
//   //     buyerZoneName: json['BuyerZoneName'] ?? '',
//   //     tat: json['TAT'] ?? '',
//   //     description: json['Description'] ?? '',
...
//   //     weFastClusterSeller: json['WeFastClusterSeller'] ?? '',
//   //     stockCat: json['StockCat'] ?? '',
//   //     latestStock: json['LatestStock'] == null
//   //         ? 0.0
//   //         : double.parse(json['LatestStock'].toString()),
//   //   );
//   // }
//
//
...
//       partNumber: json['PARTNUMBER'],
//       sellerStock: json['SellerStock'].toDouble(),
//       freeStock: json['FreeStock'].toDouble(),
//       sellerZoneName: json['SellerZoneName']??'',
//       buyerZoneName: json['BuyerZoneName']??'',
//       tat: json['TAT']??0,
//       description: json['Description']??'',
